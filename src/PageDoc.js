...
const PageDoc = () => {
  return (
    <div>
      ...
      <p>
        2. Determine an owner for the Getting Started scenario example. You can use this tool <a href="https://prod.virtualsmiley.docs.aws.a2z.com/#/services" target="_blank" rel="noopener noreferrer">
          Virtual Smiley.
        </a>
      </p>
      <p>
      ...
      <p>
        You enter the Research doc URL into this application when you enter Getting Started details. This is required to enter an item
        into this system. To see a Research doc example, click here: <a href="https://quip-amazon.com/rmwUAtHv0B16/AWS-Systems-Manager-SDK-getting-started-scenario-reseach-doc" target="_blank" rel="noopener noreferrer">
        AWS Systems Manager getting started scenario reseach doc.</a>
      </p>
      <p>
        4. Enter the Getting Started details in the <i>Enter Getting Started Details</i> section. This generates a unqiue item id 
        that you can use to track the item through the various states. 
      </p>
      <p>
        ...
        Confirm that the service team will onboard to SoS when the scenario is done.</p>
          
      <p>
        6. Enter the rubric information in the "Enter Rubric Information" section to determine if this Getting Started scenario 
        has merit to proceed. The information you gathered, such as whether the team will onboard to SOS, 
      ...
      <p>
        7. Bring the draft item along with feedback from the AWS service team to the next Getting Started meeting. It's during that meeting,
         the getting started item will be accepted or rejected. <u>You cannot approve an item without team input.</u> 
      </p>
      <p>
      ...
      <p>
        ...
        Modify details such as the Engineer that will implement the follow and the follow programming language. The other details should 
        remain the same. The system does not require a Rubic check for follow because that information was completed during the scout.</p> 
      <p>
